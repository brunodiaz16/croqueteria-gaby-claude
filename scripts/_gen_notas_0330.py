...
pedidos = {
    "Dartacan": [
        ("Cat Chow Mariscos 20kg",          2),
        ("Ganador Premium 21kg",             1),
        ("Ganador Adulto 20kg Razas Med.",   1),
        ("Gatina 15kg",                      2),
        ("Campeon Recetas Caseras 25kg",     1),
    ],
    "Invet": [
        ("ProPlan Vet EN Gastroenteric 380g",3),
        ("ProPlan Lata OM Overweight 377g",  1),
    ],
    "Chapetes": [
        ("Chapetes Super Premium Gato 5kg",  1),
    ],
    "Costco": [
        ("Arena Scoop Away 19kg 2-Pack",     1),
    ],
}
